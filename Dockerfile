...
ADD https://download.litecoin.org/litecoin-0.13.2/linux/litecoin-0.13.2-x86_64-linux-gnu.tar.gz /tmp/
RUN cd /tmp && tar xvfz litecoin-0.13.2-x86_64-linux-gnu.tar.gz && cp -R litecoin-0.13.2/bin/* /usr/bin && mkdir /var/run/litecoind && \
